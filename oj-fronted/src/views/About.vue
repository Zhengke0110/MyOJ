  ...
  >
    ...
    >
      <div class="flex flex-col items-center justify-between lg:flex-row py-16">
        <div class="relative">
          <div class="absolute top-0 -left-48 z-0 opacity-50"></div>
          <div class="lg:max-w-xl lg:pr-5 relative z-40">
            <p class="flex text-sm uppercase">About This</p>
            <h2
              class="mb-6 max-w-lg text-3xl font-light leading-snug tracking-tight"
            >
              这是一个基于Docker的代码沙箱
            </h2>
            <p class="text-base text-gray-700">
              本项目用Java代码操作Docker进行拉取镜像、创建容器、在容器中运行用户代码等一系列操作
            </p>
            <div class="mt-10 flex flex-col items-center md:flex-row">
              <a
                :href="CodeAddress"
                class="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-green-600 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-300 focus:outline-none md:mr-4 md:mb-0 md:w-auto"
              >
                View More</a
              >
              <a
        ...
        <div class="relative hidden lg:ml-32 lg:block lg:w-1/2">
          ...
          >
            <img class="w-full h-full" :src="DockerLogo" />
          </div>
        </div>
      </div>
    </div>
...
import { DockerLogo, CodeAddress, BlogAddress } from "@/config";
</script>
