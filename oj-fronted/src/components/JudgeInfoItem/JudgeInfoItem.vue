...
const { lable = "", value = 0 } = defineProps<{
  lable: string;
  value: number;
}>();
const emits = defineEmits(["increased", "decreased"]);
const increased = () => emits("increased", value + 1);
const decreased = () => emits("decreased", value - 1);
</script>
